...
export function ScrollToBottomFab({
  ...
  return (
    <button
      type="button"
      onClick={onClick}
      className="absolute bottom-4 right-4 sm:right-6 z-40 p-3 bg-white dark:bg-gray-800 text-gray-600 dark:text-gray-400 rounded-full shadow-lg hover:shadow-xl hover:bg-gray-50 dark:hover:bg-gray-700 transition-all duration-200 transform hover:scale-105"
