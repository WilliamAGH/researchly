...
export function ScrollToBottomFab({
  ...
  return (
    <button
      type="button"
      onClick={onClick}
      className="p-3 bg-white dark:bg-gray-800 text-gray-600 dark:text-gray-400 rounded-full shadow-lg hover:shadow-xl hover:bg-gray-50 dark:hover:bg-gray-700 transition-all duration-200 transform hover:scale-105"
